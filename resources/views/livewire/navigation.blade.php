<nav class="bg-gray-800" x-data="{ open: false }">
    ...
    <div class="md:hidden" id="mobile-menu" x-show="open" x-on:click.away="open = false">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4" x-data="{ openM: false }">
            <div class="flex items-center px-5" x-on:click="openM = true">
                <a href="/" class="flex-shrink-0">
            ...
            <div class="mt-3 space-y-1 px-2" x-show="openM" x-on:click.away="openM = false">
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    @csrf
                    <a href="{{ route('logout') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"
